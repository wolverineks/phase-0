...
//
// What tests did you have trouble passing? What did you do to make it pass? Why
// did that work? We had trouble initially removing the property eyeColor from
// the terah object. The syntax is different than ruby, and strange at first. To
// make it work, we consulted the js documentation to find the proper syntax.

// How difficult was it to add and delete properties outside of the object
// itself? Once we knew the command to delete a property, it was really easy.
// Adding was also fairly easy, except there are at least two ways to add more
// properties, so we tried them all to be certain.

// What did you learn about manipulating objects in this challenge? We learned
// that there are multiple ways of adding and referencing properties to an
// object. We also learned the proper syntax for deleting properties from an
// object.
