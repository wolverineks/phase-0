...
#     expect(my_array_finding_method(i_want_pets, 't')).to eq %w(want pets but)
#   end
#
#   it "selects all words with an 'a' in the original order" do
#     expect(my_array_finding_method(i_want_pets, 'a')).to eq %w(want have)
#   end
# end
#
...
#     expect(my_hash_finding_method(my_family_pets_ages, 3)).to eq %w(Hoobie Ditto)
#   end
#
...
#     expect(my_array_splitting_method(i_want_pets)).to eq [[3, 2], %w(I want pets but only have)]
#   end
#
#   it 'operates non-destructively' do
